...
public class MainMenu extends BaseDialog {
    ...
    public ButtonEntry[] buttonEntries = new ButtonEntry[]{
            new ButtonEntry(ZHXSIcons.startIcon,
    ...
    public void build() {
        cont.clear();
        cont.top().table(main->{
            main.image(ZHXS.modLogo).size(650,200).padTop(30);
            main.row();
            ...
            main.row();
            main.add("UNSTABLE VERSION ZHXS").get().setFontScale(2);
            main.row();
            ...
            main.pane(menu -> {
                ...
                for(ButtonEntry entry : buttonEntries){
                    ...
                    }, ZHXSStyles.underline, entry.run);
                    menu.row();
                }
            }).grow();
        ...
        row();
        table(t -> {
            t.add(ZHXS.modDisplayName + ZHXS.modDisplayVersion).left().padLeft(3);
